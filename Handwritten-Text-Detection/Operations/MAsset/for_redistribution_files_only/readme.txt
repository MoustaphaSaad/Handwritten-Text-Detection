...
. If the target machine does not have the version 9.0 of the MATLAB Runtime installed, 
...
MAsset_overview.html - HTML overview documentation file for the generated component. It 
                       contains the requirements for accessing the component and for 
                       generating arguments using the MWArray class hierarchy.

MAsset.xml - This file contains the code comments for the MAsset component classes and 
                       ...
                       online documentation for the MAsset component.
